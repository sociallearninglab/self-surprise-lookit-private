        ...
        return {
            frames: {
                ...
                'majority-test-win-feedback': {
                    'kind': 'exp-lookit-images-audio',
                    'generateProperties': 'function(expData, sequence, child, pastSessions, conditions){ let theaudio = expData[sequence[sequence.length - 1]][\'selectedImage\'] === \'star\' ? \'majority_control_question_winners_correct\' : \'majority_control_question_winners_incorrect\'; let images = []; const centerOffset = 15; const spacing = 50; images.push({ id: \'star\', src: \'star_hd_selected.png\', left: centerOffset, top: 30, width: 15, height: 35, nonChoiceOption: true }); images.push({ id: \'dash\', src: \'dash_card.png\', left: centerOffset + spacing, top: 30, width: 15, height: 35, nonChoiceOption: true }); return { images: images, audio: theaudio }; }',
                    'baseDir': 'https://raw.githubusercontent.com/sociallearninglab/self-surprise-lookit-private/main',
                    'audioTypes': ['mp3'],
                    'waitForEndAudio': false,
                    'canMakeChoiceBeforeAudioFinished': true,
                ...
                'majority-test-lose-feedback': {
                    'kind': 'exp-lookit-images-audio',
                    'generateProperties': 'function(expData, sequence, child, pastSessions) { let theaudio = expData[sequence[sequence.length - 1]][\'selectedImage\'] === \'dash\' ? \'control_question_losers_correct\' : \'control_question_losers_incorrect\'; let images = []; const centerOffset = 15; const spacing = 50; images.push({ id: \'star\', src: \'star_hd.png\', left: centerOffset, top: 30, width: 15, height: 35, nonChoiceOption: true }); images.push({ id: \'dash\', src: \'dash_selected.png\', left: centerOffset + spacing, top: 30, width: 15, height: 35, nonChoiceOption: true }); return { images: images, audio: theaudio }; }',
                    'baseDir': 'https://raw.githubusercontent.com/sociallearninglab/self-surprise-lookit-private/main',
                    'audioTypes': ['mp3'],
                    'waitForEndAudio': false,
                    'canMakeChoiceBeforeAudioFinished': true,
                ...
                'minority-test-win-feedback': {
                    'kind': 'exp-lookit-images-audio',
                    'generateProperties': 'function(expData, sequence, child, pastSessions) { let theaudio = expData[sequence[sequence.length - 1]][\'selectedImage\'] === \'sun\' ? \'minority_control_question_winners_correct\' : \'minority_control_question_winners_incorrect\'; let images = []; const centerOffset = 15; const spacing = 50; images.push({ id: \'sun\', src: \'sun_hd_selected.png\', left: centerOffset, top: 30, width: 15, height: 35, nonChoiceOption: true }); images.push({ id: \'dash\', src: \'dash_card.png\', left: centerOffset + spacing, top: 30, width: 15, height: 35, nonChoiceOption: true }); return { images: images, audio: theaudio }; }',
                    'baseDir': 'https://raw.githubusercontent.com/sociallearninglab/self-surprise-lookit-private/main',
                    'audioTypes': ['mp3'],
                    'choiceRequired': false,
                    'autoProceed': false,
                ...
                'minority-test-lose-feedback': {
                    'kind': 'exp-lookit-images-audio',
                    'generateProperties': 'function(expData, sequence, child, pastSessions) { let theaudio = expData[sequence[sequence.length - 1]][\'selectedImage\'] === \'dash\' ? \'control_question_losers_correct\' : \'control_question_losers_incorrect\'; let images = []; const centerOffset = 15; const spacing = 50; images.push({ id: \'sun\', src: \'sun_hd.png\', left: centerOffset, top: 30, width: 15, height: 35, nonChoiceOption: true }); images.push({ id: \'dash\', src: \'dash_selected.png\', left: centerOffset + spacing, top: 30, width: 15, height: 35, nonChoiceOption: true }); return { images: images, audio: theaudio }; }',
                    'baseDir': 'https://raw.githubusercontent.com/sociallearninglab/self-surprise-lookit-private/main',
                    'audioTypes': ['mp3'],
                    'choiceRequired': false,
                    'autoProceed': false,
